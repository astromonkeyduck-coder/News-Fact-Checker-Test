...
Run the focused story assistant, speech, voice and article-companion backend tests, then the publication suite and build. Check `package.json` for the dedicated SDK build command. Test at 375/390/768/1280/1440-pixel widths and with keyboard controls. Document the exact agent settings, environment variable names, remaining limitations, and the live checks actually completed.
